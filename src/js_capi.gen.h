...
namespace Lumix {
	...
	static int property_animator_setEnabled(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<bool>(ctx, 0);
	...
	static int property_animator_setAnimation(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Path>(ctx, 0);
	...
	static int animator_setDefaultSet(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<u32>(ctx, 0);
	...
	static int gui_rect_setLeftPoints(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
	...
	static int gui_button_setHoveredColorRGBA(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec4>(ctx, 0);
	...
	static int gui_button_setHoveredCursor(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (os::CursorType)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int gui_text_setFontSize(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<int>(ctx, 0);
	...
	static int gui_text_setHAlign(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (TextHAlign)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int gui_text_setVAlign(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (TextVAlign)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int gui_text_setText(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<const char*>(ctx, 0);
	...
	static int d6_joint_setXMotion(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (PhysicsModule::D6Motion)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int d6_joint_setTwistLimit(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec2>(ctx, 0);
	...
	static int d6_joint_setConnectedBody(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<EntityPtr>(ctx, 0);
	...
	static int d6_joint_setAxisPosition(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec3>(ctx, 0);
	...
	static int rigid_actor_setDynamicType(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (PhysicsModule::DynamicType)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int wheel_setSlot(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (PhysicsModule::WheelSlot)JSWrapper::checkArg<i32>(ctx, 0);
	...
	static int jolt_mesh_setPath(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Path>(ctx, 0);
		module->setMeshPath(entity, value);
		return 0;
	}
	...
	static int jolt_sphere_setRadius(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
		module->setSphereRadius(entity, value);
		return 0;
	}
	...
	static int jolt_box_setHalfExtents(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec3>(ctx, 0);
		module->setBoxHalfExtents(entity, value);
		return 0;
	}
	...
	static int jolt_body_setDescreteMotion(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<bool>(ctx, 0);
		module->setDiscreteMotion(entity, value);
		return 0;
	}
	...
	static int jolt_body_setFriction(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
		module->setFriction(entity, value);
		return 0;
	}
	...
	static int jolt_body_setRestitution(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
		module->setRestitution(entity, value);
		return 0;
	}
	...
	static int jolt_body_setLinearDamping(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
		module->setLinearDamping(entity, value);
		return 0;
	}
	...
	static int jolt_body_setAngularDamping(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<float>(ctx, 0);
		module->setAngularDamping(entity, value);
		return 0;
	}
	...
	static int jolt_body_setDynamicType(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (JPH::EMotionType)JSWrapper::checkArg<i32>(ctx, 0);
		module->setDynamicType(entity, value);
		return 0;
	}
	...
	static int jolt_body_setLayer(duk_context* ctx) {
		...
		EntityRef entity = {JSWrapper::toType<i32>(ctx, -1)};
		duk_pop_2(ctx);
		auto value = (ObjectLayer)JSWrapper::checkArg<i32>(ctx, 0);
		module->setLayer(entity, value);
		return 0;
	}
	...
	static int jolt_body_setLinearVelocity(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec3>(ctx, 0);
		module->setLinearVelocity(entity, value);
		return 0;
	}
	...
	static int jolt_body_setAngularVelocity(duk_context* ctx) {
		...
		duk_pop_2(ctx);
		auto value = JSWrapper::checkArg<Vec3>(ctx, 0);
		module->setAngularVelocity(entity, value);
		return 0;
	}
	...
	void registerJSAPI(duk_context* ctx) {
		...
		// fur
		{
			...
			duk_push_object(ctx); // prototype
			duk_put_prop_string(ctx, -2, "prototype");
			duk_put_prop_string(ctx, -2, "fur");
			duk_get_prop_string(ctx, -1, "fur");
			duk_get_prop_string(ctx, -1, "prototype");
			duk_pop_2(ctx);
		}
		// bone_attachment
		...
		// jolt_mesh
		{
			...
			duk_push_object(ctx); // prototype
			duk_put_prop_string(ctx, -2, "prototype");
			duk_put_prop_string(ctx, -2, "jolt_mesh");
			duk_get_prop_string(ctx, -1, "jolt_mesh");
			duk_get_prop_string(ctx, -1, "prototype");
			duk_push_string(ctx, "Path");
		...
		// jolt_sphere
		{
			...
			duk_push_object(ctx); // prototype
			duk_put_prop_string(ctx, -2, "prototype");
			duk_put_prop_string(ctx, -2, "jolt_sphere");
			duk_get_prop_string(ctx, -1, "jolt_sphere");
			duk_get_prop_string(ctx, -1, "prototype");
			duk_push_string(ctx, "Radius");
		...
		// jolt_box
		{
			...
			duk_push_object(ctx); // prototype
			duk_put_prop_string(ctx, -2, "prototype");
			duk_put_prop_string(ctx, -2, "jolt_box");
			duk_get_prop_string(ctx, -1, "jolt_box");
			duk_get_prop_string(ctx, -1, "prototype");
			duk_push_string(ctx, "HalfExtents");
		...
		// jolt_body
		{
			...
			duk_push_object(ctx); // prototype
			duk_put_prop_string(ctx, -2, "prototype");
			duk_put_prop_string(ctx, -2, "jolt_body");
			duk_get_prop_string(ctx, -1, "jolt_body");
			duk_get_prop_string(ctx, -1, "prototype");
			duk_push_string(ctx, "Speed");
